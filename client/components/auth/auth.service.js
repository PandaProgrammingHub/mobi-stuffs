...
export function AuthService($location, $http, $cookies, $q, appConfig, Util, User) {
  ...
  var Auth = {
    ...
    login({
      ...
      return $http.post('/auth/local', {
        ...
        .then(user => {
          ...
          throw {data: {'message':'No User Registered With Given Credentials'}};
        })
        .catch(err => {
          Auth.logout();
     ...
     * @param  {Function} callback - function(error, company)
     * @return {Promise}
     */
    companyLogin({
            email,
     ...
     * @param callback
     * @returns {result/err}
     * this function is for company signup
     */
    createCompany(companyObj, callback) {
      return User.save(companyObj, function(data) {
        return safeCb(callback)(null, companyObj);
      }, function(err) {
        return safeCb(callback)(err);
      })
        .$promise;
