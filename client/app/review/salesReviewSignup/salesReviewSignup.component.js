...
import routes from './salesReviewSignup.routes';
...
export class SalesReviewSignupComponent {
  /*@ngInject*/
...
export default angular.module('salesdoorApp.salesReviewSignup', [uiRouter])
  .config(routes)
  .component('salesReviewSignup', {
    template: require('./salesReviewSignup.html'),
    controller: SalesReviewSignupComponent,
    controllerAs: 'salesReviewSignupCtrl'
  })
  .name;
